...
export const tables = pgTable('tables', {
  ...
  id_creator: integer('id_creator').notNull().references(() => users.id_user),
});
...
export const lists = pgTable('lists', {
  ...
  id_table: integer('id_table').notNull().references(() => tables.id_table),
});
...
export const cards = pgTable('cards', {
  ...
  id_list: integer('id_list').notNull().references(() => lists.id_list),
...
export const labels = pgTable('labels', {
  ...
  id_card: integer('id_card').notNull().references(() => cards.id_card),
});
...
export const comments = pgTable('comments', {
  ...
  id_card: integer('id_card').notNull().references(() => cards.id_card),
  id_autor: integer('id_autor').notNull().references(() => users.id_user),
});
